...
let usercurrent: string[] =['AisHa','BaqaR ','ZarA','Daniyal','jHon'];

let  new_usersname: string[] =['Aliza','Baqar','Farah','Daawood','jhon'];

new_usersname.forEach(new_usersname => {

     let lowercase: string  =new_usersname.toLowerCase();

     if(usercurrent.map(c_user => c_user.toLowerCase()).includes(lowercase)){
